namespace MastersThesisPOC
{
    public interface ICompressionMechanism
    {
        ...
        (List<float>, string) ComputeBasicCompressedListReplacingOnceWithOutMultiplicationAfterNoise(string pattern, List<float> numbers, int patternStartIndex, int amountOfRoundingBits, int replacementStartIndex);
        ...
        List<float> AddCarryOverPropagationBitsTwo(List<float> numbers, string pattern);
    }
}
